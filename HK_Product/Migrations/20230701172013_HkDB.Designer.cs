...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUser", b =>
                {
                    b.Property<string>("ApplicationsApplicationId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("UsersUserId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("ApplicationsApplicationId", "UsersUserId");
            ...
            modelBuilder.Entity("HK_Product.Models.Aifile", b =>
                {
            ...
            modelBuilder.Entity("HK_Product.Models.Application", b =>
                {
                    b.Property<string>("ApplicationId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HK_Product.Models.Chat", b =>
                {
            ...
            modelBuilder.Entity("HK_Product.Models.Embedding", b =>
                {
            ...
            modelBuilder.Entity("HK_Product.Models.Member", b =>
                {
                    b.Property<string>("MemberId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HK_Product.Models.Qahistory", b =>
                {
            ...
            modelBuilder.Entity("HK_Product.Models.User", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ApplicationUser", b =>
                {
                    b.HasOne("HK_Product.Models.Application", null)
                        .WithMany()
                        .HasForeignKey("ApplicationsApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HK_Product.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HK_Product.Models.Aifile", b =>
                {
                    b.HasOne("HK_Product.Models.Application", "Application")
                        .WithMany("Aifiles")
            ...
            modelBuilder.Entity("HK_Product.Models.Application", b =>
                {
                    b.HasOne("HK_Product.Models.Member", "Member")
            ...
            modelBuilder.Entity("HK_Product.Models.Chat", b =>
                {
                    b.HasOne("HK_Product.Models.User", "User")
                        .WithMany("Chats")
            ...
            modelBuilder.Entity("HK_Product.Models.Embedding", b =>
                {
                    b.HasOne("HK_Product.Models.Aifile", "Aifile")
                        .WithMany("Embeddings")
            ...
            modelBuilder.Entity("HK_Product.Models.Qahistory", b =>
                {
                    b.HasOne("HK_Product.Models.Chat", "Chat")
